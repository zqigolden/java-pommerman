...
public class MCTSParams_V2 implements ParameterSet {
    ...
    public int safe_place_method = SAFE_PLACE_EARLY_STOP;
    public final int UCT_UCB1 = 0;
    public final int UCT_UCB1_TURNED = 1;
    public int uct_method = UCT_UCB1_TURNED;

    public double uctBias = 0;
    public boolean progressiveUnpruningEnable = false;
    public int progressiveUnpruningT = 30;
    public int progressiveUnpruningKInit = 4;
    public double progressiveUnpruningA = 50;
    public double progressiveUnpruningB = 1.3;
